...
<div class="w-full mt-4 lg:mt-[8%]">
    ...
    <div class="w-full px-4">
        <div class="w-full relative">
            ...
            <input type="search" id="search-words" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:border-none focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Search English Words" required>
    ...
    <div class="w-full h-screen mt-6 flex flex-col">
        ...
        <table class="w-full mt-2" id="words-table">
            ...
            <tr class="border-b-2 border-gray-200 font-semibold">
                <td class="w-4/12 pl-4 py-3 break-all capitalize">{{$word->english}}</td>
                <td class="px-4 py-3 w-6">:</td>
                <td class="w-full py-3 pl-8 pr-4"><span class="font-bold text-blue-800">{{$word->assamese}}</span></td>
            </tr>
            @endforeach
        </table>
    </div>
