...
<body class="antialiased bg-gradient-to-tr from-amber-100 to-amber-50">
    ...
    <header class="w-full md:bg-white fixed top-0 left-0 shadow-md z-50">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <nav class="flex space-x-4">
                        ...
                        <button type="button" class="share-btn text-gray-700 hover:text-violet-500 px-3 py-2 text-sm font-medium">Share</button>
                        <a href="#" target="_blank" class="text-gray-700 hover:text-violet-500 px-3 py-2 text-sm font-medium">Rate Us</a>
                        <a href="#" target="_blank" class="text-gray-700 hover:text-violet-500 px-3 py-2 text-sm font-medium">More Apps</a>
                    </nav>
                </div>
            </div>
            </div>
        ...
        <div class="w-full h-screen bg-black bg-opacity-40 sm:hidden transition-all ease-in-out duration-500" id="mheader-mobile-menu">
    ...
    {{-- categories --}}
    <section class="w-full max-w-2xl mx-auto min-h-screen pt-24 pb-8 px-4 lg:pb-20">
        {{$slot}}
    </section>
